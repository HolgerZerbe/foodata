...
function InfoFaq() {
    return (
        ...
        <div className="info-faq">
            ...
            Die Ampel zeigt dir den Gehalt an gesundheitsrelevanten Nährstoffen wie Fetten, Zucker und Salz. Weitere Informationen findest du <a className="link-extern" href="https://de.wikipedia.org/wiki/Lebensmittelampel" target="_blank" rel="noopener noreferrer">hier</a><br/>
            Der Nutri-score zeigt dir auf einer Skala von A bis E wie gesund das ausgewählte Produkt ist.  Weitere Informationen findest du <a className="link-extern" href="https://www.vzhh.de/sites/default/files/medien/134/dokumente/2019-10_Verbraucherzentrale-Hamburg_Fragen-und-Antworten-zum-Nutri-Score.pdf" target="_blank" rel="noopener noreferrer">hier</a><br/>
            ...
            Weitere Informationen findest <a className="link-extern" href="https://www.lebensmittelklarheit.de/informationen/naehrwertkennzeichnung-wichtige-information-fehlt-auf-vielen-lebensmitteln" target="_blank" rel="noopener noreferrer">auf dieser Seite</a> auf dieser Seite unter dem Punkt “Ausnahmen von der Nährwertkennzeichnung”.</p>
        </div>
        </>
    )
}
