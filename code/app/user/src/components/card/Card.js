        ...
        return (
            <div className="sep">
                    ...
                    <div className="font_icons">
                        <a className="icon" href={props.github} target="_blank">  <FontAwesomeIcon icon={faGithub}   size="3x"  color="black" /></a>
                        <a className="icon" href={props.linkedin} target="_blank"><FontAwesomeIcon icon={faLinkedin} size="3x"  color="black" /></a>
